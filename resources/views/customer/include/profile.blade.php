...
<div class="card">
    <div class="image-div">
        <img style="width: 155px;height: 150px; border: 8px solid #f2f2f2;" src="{{ asset('admin/user.jpeg') }}" class="profile-image mx-auto mt-4 card-img-top rounded rounded-circle">
    ...
    <div class="card-body">
      ...
      <ul class="list-inline text-dark">
        <li style="border-top:1px solid #f2f2f2" class="py-2">
            <a class="text-secondary text-decoration-none" href=""><i class="fas fa-home px-1"></i> Dashboard</a>
        </li>
        <li style="border-top:1px solid #f2f2f2" class="py-2">
            <a class="text-secondary text-decoration-none" href=""> <i class="fas fa-file-alt px-1"></i>  Edit Profile</a>
        </li>
        <li style="border-top:1px solid #f2f2f2" class="py-2">
            <a class="text-secondary text-decoration-none" href=""><i class="far fa-heart px-1"></i> Wishlist</a>
        </li>
        <li style="border-top:1px solid #f2f2f2" class="py-2">
            <a class="text-secondary text-decoration-none" href=""><i class="fas fa-file-alt px-1"></i> My Order</a>
        </li>
        <li style="border-top:1px solid #f2f2f2" class="py-2">
            <a class="text-secondary text-decoration-none" href=""><i class="fas fa-edit px-1"></i> Setting</a>
        </li>
        <li style="border-top:1px solid #f2f2f2" class="py-2">
